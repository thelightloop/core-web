/** @type {import('tailwindcss').Config} */module.exports =
{
    ...
    theme: {
        extend: {
            fontFamily: { sans: ['"Segoe UI"', '-apple-system', 'BlinkMacSystemFont', '"Helvetica Neue"', 'Arial', 'sans-serif',], },
            colors: {
                ...
                tertiary: { DEFAULT: 'oklch(var(--tertiary))', foreground: 'oklch(var(--tertiary-foreground))', },
            ...
            borderRadius: { sm: '0.375rem', md: '0.5rem', lg: '0.75rem', xl: '0.875rem', },
            screens: { xs: '480px', sm: '640px', md: '768px', lg: '1024px', xl: '1280px', '2xl': '1536px', '3xl': '1920px', '4xl': '2560px', },
        },
    },
    plugins: [],
};